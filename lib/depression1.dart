...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Depression Question n°01',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Depression Question n°01'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Couldn\'t experience the positive feeling',
                style: TextStyle(
                  color: Colors.purple,
                  fontSize: 36.0,
            ...
            Padding(
              ...
              child: RadioListTile(
                ...
                groupValue: 'Couldn\'t experience the positive feeling',
                onChanged: null,
