...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Stress Question n°07',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Colors.deepPurple),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Stress Question n°07'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Intolerant to get in what I was doing',
                style: TextStyle(
                  color: Colors.purple,
                  fontSize: 36.0,
            ...
            Padding(
              ...
              child: RadioListTile(
                ...
                groupValue: 'Intolerant to get in what I was doing',
                onChanged: null,
